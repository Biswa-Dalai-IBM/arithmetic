...
/**
 * Teaches arithmetic grammar to Claude LLM using hybrid approach:
 * 1. Claude converts natural language to formal syntax
 * 2. ANTLR validates the generated expression
 * 3. Feedback loop if validation fails
 */
public class ArithmeticGrammarTeacher {
    ...
    public ArithmeticGrammarTeacher(String apiKey, String grammarFilePath) throws Exception {
        this(apiKey, grammarFilePath, 3);
    }
    
    public ArithmeticGrammarTeacher(String apiKey, String grammarFilePath, int maxRetries) throws Exception {
        this.apiKey = apiKey;
    ...
    /**
     * Main method to teach grammar to LLM and parse user input
     */
    ...
    /**
     * Generate formal syntax using Claude API
     */
    private String generateFormalSyntax(String userInput, int attemptCount) throws Exception {
        ...
        String userPrompt = attemptCount == 0 ? 
            ...
            userInput; // For retries, userInput already contains correction prompt
        ...
        // Extract just the expression (remove any explanation)
        return extractExpression(content);
    }
    
    /**
     * Build system prompt with actual grammar file content
     */
    ...
    /**
     * Extract expression from LLM response (remove explanations)
     */
    ...
    /**
     * Evaluate the parse tree to get numeric result
     */
    ...
    /**
     * Visitor to evaluate arithmetic expressions
     */
    ...
    public static void main(String[] args) {
        if (args.length < 3) {
            System.out.println("Usage: java ArithmeticGrammarTeacher <API_KEY> <GRAMMAR_FILE> <expression>");
            System.out.println("Example: java ArithmeticGrammarTeacher sk-ant-xxx Arithmetic.g4 \"add five and three\"");
            return;
        }
        ...
        try {
            ArithmeticGrammarTeacher teacher = new ArithmeticGrammarTeacher(apiKey, grammarFile);
